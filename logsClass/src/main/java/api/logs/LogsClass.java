...
public class LogsClass {
    ...
    public LogsClass(HttpServletRequest httpServletRequest, String methodName) {
    ...
    public LogsClass(Long idThread, HttpServletRequest httpServletRequest, String methodName, LocalDateTime initialTime) {
    ...
    public BigDecimal getTimeInSeconds(LocalDateTime localDateTime) {
