...
public class LicenseEntity {
    ...
    public LicenseEntity(Long idLicense, String licenseCode, LocalDate emisionDate, LocalDate expireDate, String giveBy, CommerceEntity commerceEntity, StatusLicenseEntity statusLicenseEntity) {
