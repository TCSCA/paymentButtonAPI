...
public class JwtUtils {
    ...
    public static BankCommerceEntity validateBankCommerceInformation(String holderId) {
        ...
        if (commerceEntity != null) {
            ...
            BankCommerceEntity bankCommerceEntity = bankCommerceRepository.
                    getBankCommerceInformationByIdCommerceAndLicenseValidCreditCard(commerceEntity.getIdCommerce(), currentDate, 99L);
