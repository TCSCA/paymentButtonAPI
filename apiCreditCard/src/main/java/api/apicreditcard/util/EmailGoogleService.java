...
import api.apicreditcard.service.GmailApiService;
...
public class EmailGoogleService {
    ...
    public Message setMailInitialConfiguration(final String emailDestination, final String body, final String subject, final Multipart multipart,final HttpServletRequest httpServletRequest) throws MessagingException {
        try {
            ...
            TokenResponse token = gmailApiService.refreshAccessToken(configurationGoogleRefreshTokenEntity.getValue(),httpServletRequest);
