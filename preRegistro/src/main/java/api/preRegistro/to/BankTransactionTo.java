...
public class BankTransactionTo {
    ...
    public BankTransactionTo(String rif, String phoneNumberCommerce, String commerceName,
                             String senderIdentificationDocument, String senderPhoneNumber,
                             BigDecimal amount, Long paymentMethod, String reasonOfCollection) {
        this.rif = rif;
    ...
    public BankTransactionTo(ObjectMapper objectMapper, LinkedHashMap<String, Object> response) {
        ...
        this.reasonOfCollection = objectMapper.convertValue(((LinkedHashMap<String, Object>) response.get("bankTransactionEntity")).
                get("reasonOfCollection"), String.class);
    }
