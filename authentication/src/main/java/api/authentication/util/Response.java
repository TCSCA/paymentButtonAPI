...
public class Response implements Serializable {
    ...
    private ApprovalUserTo termsAndConditions;

    private ApprovalUserTo privacyPolicy;
    ...
    public ApprovalUserTo getTermsAndConditions() {
        return termsAndConditions;
    }

    public void setTermsAndConditions(ApprovalUserTo termsAndConditions) {
        this.termsAndConditions = termsAndConditions;
    }

    public ApprovalUserTo getPrivacyPolicy() {
        return privacyPolicy;
    }

    public void setPrivacyPolicy(ApprovalUserTo privacyPolicy) {
