...
public class ClientEntity {
    ...
    public ClientEntity(Long idClient, String clientName, String identificationDocument, String phoneNumber, String email,
                        Long registerBy, UserEntity userEntity, CommerceEntity commerceEntity, OffsetDateTime registerDate) {
        this.idClient = idClient;
