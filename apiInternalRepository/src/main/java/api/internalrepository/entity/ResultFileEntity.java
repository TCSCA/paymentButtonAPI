...
public class ResultFileEntity {
    ...
    public ResultFileEntity(Long idResultFile, Long size, Long chargedBy, CommerceEntity commerceEntity, OffsetDateTime chargedDate, RequirementEntity requirementEntity, String fileName) {
