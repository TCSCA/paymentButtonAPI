...
import api.apiAdminCommerce.entity.ProfileEntity;
import api.apiAdminCommerce.entity.StatusUserEntity;

import java.time.OffsetDateTime;

public class UsersRequiredTo {
    ...
    public UsersRequiredTo(Long idUser, String fullName, String phoneNumberClient,
                           String contactPersonEmail, String identificationDocument, String username,
                           ProfileEntity profile, StatusUserEntity statusUserEntity, OffsetDateTime registerDate,
                           String companyName, String rif, String reasonStatus) {
        this.idUser = idUser;
