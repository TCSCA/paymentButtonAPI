...
import api.apiAdminCommerce.service.GmailApiService;
...
public class EmailGoogleService {
    ...
    public   void setImageToMailFromResources(final String fileName, final Multipart multipart) throws MessagingException, IOException {
