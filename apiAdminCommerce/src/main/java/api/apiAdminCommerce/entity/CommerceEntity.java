...
public class CommerceEntity {
    ...
    @ManyToOne()
    @JoinColumn(name = "id_actividad_comercial")
    private EconomicActivityEntity economicActivityEntity;
    ...
    public CommerceEntity(Long idCommerce) {
    ...
    public EconomicActivityEntity getEconomicActivityEntity() {
        return economicActivityEntity;
    }

    public void setEconomicActivityEntity(EconomicActivityEntity economicActivityEntity) {
        this.economicActivityEntity = economicActivityEntity;
    }
