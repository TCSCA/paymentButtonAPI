...
public class AdministrativeUserEntity {
    ...
    public AdministrativeUserEntity(Long idAdministrativeUser, String name, String document, String phoneNumber, String email, UserEntity userEntity, LocalDate registerDate, Boolean active) {
