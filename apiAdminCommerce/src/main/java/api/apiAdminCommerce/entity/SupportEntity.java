...
public class SupportEntity {
    ...
    public SupportEntity(Long idSupport, String request, ClientEntity clientEntity, AdministrativeUserEntity administrativeUserEntity,
                         OffsetDateTime registerDate, OffsetDateTime updateDate, String phoneContactPerson,
                         String contactEmail) {
