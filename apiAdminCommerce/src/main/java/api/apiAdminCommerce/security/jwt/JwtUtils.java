...
import api.apiAdminCommerce.repository.intDbRepository.TokenRepository;
import api.apiAdminCommerce.util.SecurityUtils;
...
public class JwtUtils {
   ...
   /* public static Boolean validateAuthToken(HttpServletRequest httpServletRequest, Long idUser) {
        ...
        TokenEntity tokenEntity = tokenRepository.getTokenByIdUserAndProfileAdmin(idUser, token);
        if(tokenEntity == null) {
            return false;
        }
        return true;
