...
import api.apiAdminCommerce.entity.HistoryPasswordEntity;
...
public interface HistoryPasswordRepository extends JpaRepository<HistoryPasswordEntity, Long> {
    ...
    @Query(value = "select history from HistoryPasswordEntity as history " +
    ...
    List<HistoryPasswordEntity> getHistoryRepositoryByIdUser(@Param("idUser") final Long idUser);
